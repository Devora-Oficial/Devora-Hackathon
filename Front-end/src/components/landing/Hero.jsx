...
export default function Hero() {
  return (
    <section className="pt-28 pb-20 relative overflow-hidden">
      <div className="absolute -left-40 -top-24 w-[720px] h-[720px] rounded-full bg-linear-to-r from-purple-600 to-indigo-500 opacity-20 blur-3xl pointer-events-none"></div>
      <div className="absolute right-[-200px] top-10 w-[520px] h-[520px] rounded-full bg-linear-to-tr from-indigo-600 to-cyan-500 opacity-10 blur-2xl pointer-events-none"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 flex flex-col-reverse lg:flex-row items-center gap-12">
        ...
        >
          <div className="w-[380px] md:w-[520px] lg:w-[560px] p-6 rounded-3xl bg-linear-to-br from-white/3 to-white/2 border border-white/8 shadow-2xl relative">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-3 rounded-lg bg-linear-to-br from-purple-600/20 to-indigo-600/10 border border-white/6">
                <div className="h-6 w-24 bg-white/10 rounded mb-3"></div>
                <div className="h-8 bg-white/8 rounded"></div>
              </div>
              <div className="p-3 rounded-lg bg-linear-to-br from-indigo-600/20 to-cyan-500/10 border border-white/6">
            ...
            <div className="absolute -left-8 -bottom-6 w-36 h-36 rounded-full bg-linear-to-tr from-purple-500 to-indigo-400 opacity-40 blur-xl"></div>
          </div>
        </motion.div>
